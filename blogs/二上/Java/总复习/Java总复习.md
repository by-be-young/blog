...
> 例题（2025 模拟）：下列关于权限的说法中错误的是：
> 
>    A Java中一共有四种访问权限控制，其权限的大小顺序：public > protected > default > private  
> 
>   B 普通方法可以使用四种访问权限，但是抽象方法不能使用 `private` 来修饰  
> 
>   C 构造器可以使用四种访问权限  
> 
>   D `protected` 所修饰的成员，对于同包子类可访问，但是外包子类不可访问
> 
> [answer]
> 
> A 正确
...
> 例题（2025 模拟）：关于Java类LinkedList的特点，下面描述正确的是：
> 
> A、查询快
> 
> B、增加快
